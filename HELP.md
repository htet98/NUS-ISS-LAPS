...
* The original package name 'nus-iss.LAPS' is invalid and this project uses 'nus_iss.LAPS' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/4.0.5/reference/web/spring-hateoas.html)
